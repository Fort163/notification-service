...
import com.quick.recording.notification.service.config.property.WebSocketProperty;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        registry.enableStompBrokerRelay("/queue", "/topic")
                ...
                .setAutoStartup(true)
                .setRelayHost(property.getHost())
                .setRelayPort(property.getPort())
                .setClientLogin(property.getLogin())
                .setClientPasscode(property.getPassword());
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/api/v1/notification/socket")
                .setAllowedOrigins(Objects.requireNonNullElse(property.getAllowedOrigins(),List.of())
